...
namespace ZQUSR.BLL
{
    public class PageValidate
    {
        ...
        #region 数字字符串检查
        public bool IsPhone(string inputData)
        {
        ...
        public string FetchInputDigit(System.Web.HttpRequest req, string inputKey, int maxLen)
        {
        ...
        public string SqlTextClear(string sqlText)
        {
            if (sqlText == null)
            {
                return null;
        ...
        #region 是否由特定字符组成
        public bool isContainSameChar(string strInput)
        {
        ...
        public bool isContainSameChar(string strInput, string charInput, int lenInput)
        {
        ...
        /// </summary>
        public bool isContainSpecChar(string strInput)
        {
