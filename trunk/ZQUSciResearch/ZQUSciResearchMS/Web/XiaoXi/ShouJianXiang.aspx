<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShouJianXiang.aspx.cs"
    Inherits="Web.XiaoXi.ShouJianXiang" %>
        ...
        <table>
            <tr>
                <td colspan="3">
                    ...
                    <asp:Label ID="lblSmallSort" runat="server" Text="收件箱"></asp:Label>
                </td>
            </tr>
            <tr>
                <td colspan="3">
                    <asp:GridView ID="GVMsgListByReceiver" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="FK_SenderID" HeaderText="发送者">
