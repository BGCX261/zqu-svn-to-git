<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShouLu_Evaluate.aspx.cs" Inherits="Web.KaoHe.ShouLu_Evaluate" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>收录/转载情况级别设置</title>
...
<body>
    ...
    <ajaxToolkit:TabPanel HeaderText="收录/转载情况级别设置列表" ID="TabPanel1" runat="server" TabIndex="0">
    <ContentTemplate><asp:GridView ID="GridView1" runat="server" CssClass="gridviewStyle" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Type" HeaderText="论文类型" ReadOnly="True" />
                <asp:BoundField DataField="Situation" HeaderText="收录/转载情况" ReadOnly="True" />
    ...
    <ajaxToolkit:TabPanel HeaderText="收录/转载情况级别设置添加" ID="TabPanel2" runat="server">
    <ContentTemplate>
            ...
            <tr>
                ...
                <td class="table_none">
                    <asp:DropDownList ID="ddlType" runat="server">
                        <asp:ListItem Value="-1">请选择...</asp:ListItem>
                        <asp:ListItem Value="学术论文">学术论文</asp:ListItem>
                        <asp:ListItem Value="学术期刊论文">学术期刊论文</asp:ListItem>
                        <asp:ListItem Value="学术会议论文">学术会议论文</asp:ListItem>
                    </asp:DropDownList>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="*请选择论文类型" ControlToValidate="ddlType" InitialValue="-1" ValidationGroup="Add"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td class="table_body">
                ...
                <td class="table_none">
                    <asp:TextBox ID="txtSituation" runat="server" Width="400px"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="*请填写期刊名称" ControlToValidate="txtSituation" ValidationGroup="Add"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td class="table_body">
