<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SKJD_Evaluate.aspx.cs" Inherits="Web.KaoHe.SKJD_Evaluate" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>社科鉴定成果评定标准</title>
...
<body>
    ...
    <ajaxToolkit:TabPanel HeaderText="社科鉴定成果评定标准列表" ID="TabPanel1" runat="server" TabIndex="0">
    <ContentTemplate><asp:GridView ID="GridView1" runat="server" CssClass="gridviewStyle" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Source" HeaderText="成果来源" ReadOnly="True" />
                <asp:BoundField DataField="Grade" HeaderText="鉴定等级" ReadOnly="True" />
    ...
    <ajaxToolkit:TabPanel HeaderText="社科鉴定成果评定标准添加" ID="TabPanel2" runat="server">
    <ContentTemplate>
        <table class="table-box">
            ...
            <tr>
                ...
                <td class="table_none">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="*请填写成果来源" ControlToValidate="txtSource" ValidationGroup="Add"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td class="table_body">
                ...
                <td class="table_none">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="*请选择鉴定类型" ControlToValidate="ddlGrade" InitialValue="-1" ValidationGroup="Add"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td class="table_body">
