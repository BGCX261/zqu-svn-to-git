<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Periodicals_Evaluate.aspx.cs" Inherits="Web.KaoHe.Periodicals_Evaluate" %>
...
<body>
    ...
    <ajaxToolkit:TabPanel HeaderText="期刊级别设置列表" ID="TabPanel1" runat="server" TabIndex="0">
    ...
    <ajaxToolkit:TabPanel HeaderText="期刊级别设置添加" ID="TabPanel2" runat="server">
    <ContentTemplate>
            ...
            <tr>
                ...
                <td class="table_none">
                    <asp:DropDownList ID="ddlQikanKey" runat="server">
                        <asp:ListItem Value="-1">请选择...</asp:ListItem>
                        <asp:ListItem Value="SCI-E">SCI-E</asp:ListItem>
                        <asp:ListItem Value="EI">EI</asp:ListItem>
                        <asp:ListItem Value="CSCD">CSCD</asp:ListItem>
                        <asp:ListItem Value="ISAP">ISAP</asp:ListItem>
                        <asp:ListItem Value="A&HCI">A&HCI</asp:ListItem>
                        <asp:ListItem Value="CSSCI">CSSCI</asp:ListItem>
                        <asp:ListItem Value="ISSHP">ISSHP</asp:ListItem>
                    </asp:DropDownList>
