<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KJYY_Evaluate.aspx.cs" Inherits="Web.KaoHe.KJYY_Evaluate" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>科技应用成果评定标准</title>
...
<body>
    ...
    <ajaxToolkit:TabPanel HeaderText="科技应用成果评定标准列表" ID="TabPanel1" runat="server" TabIndex="0">
    ...
    <ajaxToolkit:TabPanel HeaderText="科技应用成果评定标准添加" ID="TabPanel2" runat="server">
    <ContentTemplate>
