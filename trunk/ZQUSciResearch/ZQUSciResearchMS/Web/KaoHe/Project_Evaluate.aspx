<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Project_Evaluate.aspx.cs" Inherits="Web.KaoHe.Project_Evaluate" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>科研项目评定标准</title>
...
<body>
    ...
    <ajaxToolkit:TabPanel HeaderText="科研项目评定标准列表" ID="TabPanel1" runat="server" TabIndex="0">
    <ContentTemplate><asp:GridView ID="GridView1" runat="server" CssClass="gridviewStyle" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Type" HeaderText="项目类型" ReadOnly="True" />
    ...
    <ajaxToolkit:TabPanel HeaderText="科研项目评定标准添加" ID="TabPanel2" runat="server">
    <ContentTemplate>
        <table class="table-box">
            ...
            <tr>
                ...
                <td class="table_none">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="*请选择项目类型" ControlToValidate="ddlType" InitialValue="-1" ValidationGroup="Add"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td class="table_body">
