<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KJJD_Evaluate.aspx.cs" Inherits="Web.KaoHe.KJJD_Evaluate" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>科技鉴定成果评定标准</title>
...
<body>
    ...
    <ajaxToolkit:TabPanel HeaderText="科技鉴定成果评定标准列表" ID="TabPanel1" runat="server" TabIndex="0">
    <ContentTemplate><asp:GridView ID="GridView1" runat="server" CssClass="gridviewStyle" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Source" HeaderText="鉴定部门" ReadOnly="True" />
                <asp:BoundField DataField="Type" HeaderText="鉴定类型" ReadOnly="True" />
    ...
    <ajaxToolkit:TabPanel HeaderText="科技鉴定成果评定标准添加" ID="TabPanel2" runat="server">
    <ContentTemplate>
        <table class="table-box">
            ...
            <tr>
                ...
                <td class="table_none">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="*请填写鉴定部门" ControlToValidate="txtSource" ValidationGroup="Add"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td class="table_body">
                ...
                <td class="table_none">
                    <asp:DropDownList ID="ddlType" runat="server">
                        <asp:ListItem Value="-1">请选择...</asp:ListItem>
                        <asp:ListItem Value="检测鉴定">检测鉴定</asp:ListItem>
                        <asp:ListItem Value="会议鉴定">会议鉴定</asp:ListItem>
                        <asp:ListItem Value="函审鉴定">函审鉴定</asp:ListItem>
                    </asp:DropDownList>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="*请选择鉴定类型" ControlToValidate="ddlType" InitialValue="-1" ValidationGroup="Add"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td class="table_body">
