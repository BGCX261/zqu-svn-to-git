<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChuangZuo_List.aspx.cs" Inherits="Web.SciResearch.ChuangZuo_List" %>
...
<body>
    ...
    <a class="add" href="ChuangZuo_Add.aspx?cmd=add">添加</a>
    
    <ajaxToolkit:TabContainer ID="TabContainer1" runat="server">
    <ajaxToolkit:TabPanel HeaderText="个人创作类成果列表" ID="TabPanel1" runat="server">
    <ContentTemplate>
                ...
                <Columns>
                   ...
                   <asp:TemplateField HeaderText="级别">
                    ...
                    <asp:HyperLinkField HeaderText="查看" DataNavigateUrlFields="PK_AID" 
                        DataNavigateUrlFormatString="/Preview/ChuangZuo_Preview.aspx?cmd=preview&srid={0}" Text="查看" />
                    <asp:HyperLinkField DataNavigateUrlFields="PK_AID" 
                        DataNavigateUrlFormatString="ChuangZuo_Add.aspx?cmd=modify&srid={0}" 
