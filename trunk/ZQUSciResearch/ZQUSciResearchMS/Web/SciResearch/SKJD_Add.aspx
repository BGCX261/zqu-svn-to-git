<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SKJD_Add.aspx.cs" Inherits="Web.SciResearch.SKJD_Add" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>社科鉴定成果录入</title>
...
<body>
    ...
    <a class="back" href="SKJD_List.aspx">返回</a>
    
    <ajaxToolkit:TabContainer ID="TabContainer1" runat="server"> 
        <ajaxToolkit:TabPanel HeaderText="社科鉴定成果添加" ID="TabPanel1" runat="server">
        <ContentTemplate>
            ...
            <table class="table-box">
                ...
                <tr>
                    ...
                    <td class="table_none">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="请选择鉴定日期" ControlToValidate="txtTime"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td class="table_body">
                ...
                <tr>
                    ...
                    <td class="table_none">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="*请选择鉴定等级" ControlToValidate="ddlGrade" InitialValue="-1"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td class="table_body">
