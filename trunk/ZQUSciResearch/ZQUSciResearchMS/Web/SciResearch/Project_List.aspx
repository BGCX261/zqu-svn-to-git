<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Project_List.aspx.cs" Inherits="Web.SciResearch.Project_List" %>
...
<body>
    ...
    <a class="add" href="Project_Add.aspx?cmd=add">添加</a>
    
    <ajaxToolkit:TabContainer ID="TabContainer1" runat="server">
    <ajaxToolkit:TabPanel HeaderText="个人科研项目列表" ID="TabPanel1" runat="server">
    <ContentTemplate>
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"  CssClass="gridviewStyle" 
                ...
                <Columns>
                   ...
                   <asp:BoundField DataField="Type" HeaderText="项目类型" />
                    <asp:BoundField DataField="Source" HeaderText="项目来源" />
                    <asp:BoundField DataField="PublishTime1" HeaderText="项目完成日期" DataFormatString="{0:yyyy-MM-dd}" />
                   <asp:TemplateField HeaderText="级别">
                    ...
                    <asp:HyperLinkField DataNavigateUrlFields="PK_PID" 
                        DataNavigateUrlFormatString="Project_Preview.aspx?cmd=modify&srid={0}" 
