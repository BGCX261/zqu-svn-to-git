<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChuangZuo_Add.aspx.cs" Inherits="Web.SciResearch.ChuangZuo_Add" %>
...
<body>
    ...
    <a class="back" href="ChuangZuo_List.aspx">返回</a>
    
    <ajaxToolkit:TabContainer ID="TabContainer1" runat="server">
        
        <ajaxToolkit:TabPanel HeaderText="创作类成果添加" ID="TabPanel1" runat="server">
        <ContentTemplate>
            ...
            <table class="table-box">
                ...
                <tr>
                    ...
                    <td class="table_none">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*请选择发表日期" ControlToValidate="txtTime"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td class="table_body">
                ...
                <tr>
                    ...
                    <td class="table_none">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="*请选择学科" ControlToValidate="ddlType" InitialValue="-1"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td class="table_body">
                    ...
                    <td class="table_none">
                        <asp:DropDownList ID="ddlUnit" runat="server">
                            <asp:ListItem Value="-1">请先选择学科...</asp:ListItem>
                        </asp:DropDownList>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="*请选择发表刊物名称/来源" ControlToValidate="ddlUnit" InitialValue="-1"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td class="table_body">
                    ...
                    <td class="table_none">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="*请选择学校署名单位" ControlToValidate="ddlSchoolSign" InitialValue="-1"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td class="table_body">
                ...
                <tr>
                    <td class="table_body">
                        <asp:Label ID="lblAllAuthor1" runat="server" ForeColor="Red" Text="*" Visible="False"></asp:Label>
