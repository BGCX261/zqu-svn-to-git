<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RuanKeXue_Add.aspx.cs" Inherits="Web.SciResearch.RuanKeXue" %>
...
<body>
    ...
    <a class="back" href="RuanKeXue_List.aspx">返回</a>
    
    <ajaxToolkit:TabContainer ID="TabContainer1" runat="server"> 
        <ajaxToolkit:TabPanel HeaderText="软科学成果添加" ID="TabPanel1" runat="server">
        <ContentTemplate>
            ...
            <table class="table-box">
                ...
                <tr>
                    ...
                    <td class="table_none">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*请选择采纳日期" ControlToValidate="txtTime" InitialValue="-1"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td class="table_body">
                    ...
                    <td class="table_none">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="*请填写成果名称" ControlToValidate="txtTitle" InitialValue="-1"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td class="table_body">
                    ...
                    <td class="table_none">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="*请选择采纳部门" ControlToValidate="ddlUnit" InitialValue="-1"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td class="table_body">
