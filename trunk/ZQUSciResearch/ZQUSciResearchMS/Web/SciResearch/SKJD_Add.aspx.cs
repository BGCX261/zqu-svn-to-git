...
{
    public partial class SKJD_Add : System.Web.UI.Page
    {
        ...
        {
            ddlSource.DataSource = EvaluateBll.GetSourceByClass("社科鉴定成果");
        ...
        #region 绑定鉴定等级下拉列表
        private void BindDdlGrade()
        {
            ddlGrade.DataSource = EvaluateBll.GetGradeByClass("社科鉴定成果");
            ddlGrade.DataTextField = "Type";
            ddlGrade.DataBind();
            ddlGrade.Items.Insert(0, new ListItem("请选择...", "-1"));
        } 
        #endregion
