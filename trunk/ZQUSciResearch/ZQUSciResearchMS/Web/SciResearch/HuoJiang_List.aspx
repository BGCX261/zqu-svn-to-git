<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HuoJiang_List.aspx.cs" Inherits="Web.SciResearch.HuoJiang_List" %>
...
<body>
    ...
    <a class="add" href="HuoJiang_Add.aspx?cmd=add">添加</a>
    
    <ajaxToolkit:TabContainer ID="TabContainer1" runat="server">
    <ajaxToolkit:TabPanel HeaderText="个人获奖成果列表" ID="TabPanel1" runat="server">
    <ContentTemplate>
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="gridviewStyle" 
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="PublishTime" HeaderText="获奖日期" DataFormatString="{0:yyyy-MM-dd}" />
                   ...
                   <asp:TemplateField HeaderText="级别">
                    ...
                    <asp:HyperLinkField HeaderText="查看" DataNavigateUrlFields="PK_AID" 
                        DataNavigateUrlFormatString="/Preview/HuoJiang_Preview.aspx?cmd=preview&srid={0}" Text="查看" />
                    <asp:HyperLinkField DataNavigateUrlFields="PK_AID" 
                        DataNavigateUrlFormatString="HuoJiang_Add.aspx?cmd=modify&srid={0}" 
