<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HuoJiang_Add.aspx.cs" Inherits="Web.SciResearch.HuoJiang" %>
...
<body>
    ...
    <a class="back" href="HuoJiang_List.aspx">返回</a>
    
    <ajaxToolkit:TabContainer ID="TabContainer1" runat="server"> 
        <ajaxToolkit:TabPanel HeaderText="获奖成果添加" ID="TabPanel1" runat="server">
        <ContentTemplate>
            ...
            <table class="table-box">
                ...
                <tr>
                    ...
                    <td class="table_none">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*请选择成果类别" ControlToValidate="ddlType" InitialValue="-1"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td class="table_body">
                ...
                <tr>
                    ...
                    <td class="table_none">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="*请填写获奖日期" ControlToValidate="txtTime"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td class="table_body">
                    ...
                    <td class="table_none">
                        <asp:DropDownList ID="ddlSource" runat="server">
                            <asp:ListItem Value="-1">请先选择成果类别...</asp:ListItem>
                        </asp:DropDownList>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="*请选择获奖级别" ControlToValidate="ddlSource" InitialValue="-1"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td class="table_body">
                    ...
                    <td class="table_none">
                        <asp:DropDownList ID="ddlGrade" runat="server">
                            ...
                            <asp:ListItem Value="0">特等奖</asp:ListItem>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="*请选择获奖等级" ControlToValidate="ddlGrade" InitialValue="-1"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td class="table_body">
                    ...
                    <td class="table_none">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="*请选择学校署名排名" ControlToValidate="ddlSchoolSign" InitialValue="-1"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td class="table_body">
                    ...
                    <td class="table_none">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ErrorMessage="*请选择完成成果排名" ControlToValidate="ddlRank" InitialValue="-1"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td class="table_body">
                ...
                <tr>
                    <td class="table_body">
                        <asp:Label ID="lblAllAuthor1" runat="server" ForeColor="Red" Text="*" 
                            Visible="False"></asp:Label>
