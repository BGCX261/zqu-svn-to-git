<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KJYY_List.aspx.cs" Inherits="Web.SciResearch.KJYY_List" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>科技应用成果列表</title>
...
<body>
    ...
    <a class="add" href="KJYY_Add.aspx?cmd=add">添加</a>
    
    <ajaxToolkit:TabContainer ID="TabContainer1" runat="server">
    <ajaxToolkit:TabPanel HeaderText="个人科技应用成果列表" ID="TabPanel1" runat="server">
    <ContentTemplate>
                ...
                <Columns>
                   ...
                   <asp:TemplateField HeaderText="级别">
                    ...
                    <asp:HyperLinkField HeaderText="查看" DataNavigateUrlFields="PK_AID" 
                        DataNavigateUrlFormatString="/Preview/KJYY_Preview.aspx?cmd=preview&srid={0}" Text="查看" />
                    <asp:HyperLinkField DataNavigateUrlFields="PK_AID" 
                        DataNavigateUrlFormatString="KJYY_Add.aspx?cmd=modify&srid={0}" 
