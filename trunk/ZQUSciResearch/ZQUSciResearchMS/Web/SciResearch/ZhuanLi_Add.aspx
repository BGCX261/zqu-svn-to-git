<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZhuanLi_Add.aspx.cs" Inherits="Web.SciResearch.ZhuanLi_Add" %>
...
<body>
    ...
    <a class="back" href="ZhuanLi_List.aspx">返回</a>
    
    <ajaxToolkit:TabContainer ID="TabContainer1" runat="server"> 
        <ajaxToolkit:TabPanel HeaderText="专利成果添加" ID="TabPanel1" runat="server">
        <ContentTemplate>
           ...
           <div>
            <table class="table-box">
                    ...
                    <tr>
                        <td class="table_body">
                            <asp:Label ID="Label1" runat="server" Text="*" ForeColor="Red"></asp:Label>专利号：</td>
                        <td class="table_none">
                            <input ID="txtNumber" runat="server" type="text" />
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*请填写专利号" ControlToValidate="txtNumber"></asp:RequiredFieldValidator>
                            </td>
                    </tr>
                    <tr>
                        <td class="table_body">
                            <asp:Label ID="Label2" runat="server" Text="*" ForeColor="Red"></asp:Label>专利类型：</td>
                        <td class="table_none">
                            <asp:DropDownList ID="ddlType" runat="server">
                            </asp:DropDownList>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="*请选择专利类型" ControlToValidate="ddlType" InitialValue="-1"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td class="table_body">
                        ...
                        <td class="table_none">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="*请填写成果名称" ControlToValidate="txtTitle"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td class="table_body">
                            <asp:Label ID="Label4" runat="server" Text="*" ForeColor="Red"></asp:Label>授权单位：</td>
                        <td class="table_none">
                            <asp:TextBox ID="txtUnit" runat="server"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="*请填写授权单位" ControlToValidate="txtUnit"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td class="table_body">
                            <asp:Label ID="Label5" runat="server" Text="*" ForeColor="Red"></asp:Label>授权日期：</td>
                        <td class="table_none">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="*请选择授权日期" ControlToValidate="txtTime"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td class="table_body">
                            <asp:Label ID="Label7" runat="server" Text="*" ForeColor="Red"></asp:Label>学校署名排名：</td>
                        <td class="table_none">
                    ...
                    <tr>
                        <td class="table_body">
                            <asp:Label ID="Label8" runat="server" Text="*" ForeColor="Red"></asp:Label>完成成果排名：</td>
                        <td class="table_none">
                    ...
                    <tr>
                        <td class="table_body">
                            <asp:Label ID="lblPopulation1" runat="server" Text="*" ForeColor="Red" 
