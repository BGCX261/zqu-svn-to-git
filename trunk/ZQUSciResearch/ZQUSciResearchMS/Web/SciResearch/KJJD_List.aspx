<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KJJD_List.aspx.cs" Inherits="Web.SciResearch.KJJD_List" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>科技鉴定成果列表</title>
...
<body>
   <%-- <script type="text/javascript">
    ...
    <a class="add" href="KJJD_Add.aspx?cmd=add">添加</a>
    
    <ajaxToolkit:TabContainer ID="TabContainer1" runat="server">
    <ajaxToolkit:TabPanel HeaderText="个人科技鉴定成果列表" ID="TabPanel1" runat="server">
    <ContentTemplate>
