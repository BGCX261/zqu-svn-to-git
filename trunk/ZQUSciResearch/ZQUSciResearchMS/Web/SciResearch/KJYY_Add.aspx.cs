...
{
    public partial class KJYY : System.Web.UI.Page
    {
        ...
        {
            ddlSource.DataSource = EvaluateBll.GetSourceByClass("科技应用成果");
        ...
        private void Save(string strAuditState)
        {
            if (Session["UserID"] != null)
            {
                ...
                try
                {
                    if (txtTime.Text == "")
                    {
                        MessageBox.Show(this, "获批日期不能为空！");
                        txtTime.Focus();
                    }
                    else if (!PageValidateBll.IsDateTime(txtTime.Text))
                    {
                        MessageBox.Show(this, "获批日期格式不正确！");
                        txtTime.Focus();
                    }
                    ...
                    else
                    {
                        ...
                        AchievementModel.PublishTime = dtPublishTime;   //获批日期
                        ...
                        //计算成果总得分
                        EvaluateModel = EvaluateBll.GetKJYYJiBie(AchievementModel);
                        string strJiBie = "";   //级别
                        ...
                        if (!(intRank == -1 || intRank == 0))
                        {
                            ...
                            else
                            {
                                ...
                                if (Cal2Model != null)
                                {
                                    ...
                                    Response.Redirect("KJYY_List.aspx");
                                }
                            }
                        }
                        else
