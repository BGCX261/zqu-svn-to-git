<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Thesis_List.aspx.cs" Inherits="Web.SciResearch.Thesis_List" %>
...
<body>
    ...
    <a class="add" href="Thesis_Add.aspx?cmd=add">添加</a>
    
    <ajaxToolkit:TabContainer ID="TabContainer1" runat="server">
    <ajaxToolkit:TabPanel HeaderText="个人学术论文列表" ID="TabPanel1" runat="server">
    <ContentTemplate>
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="gridviewStyle"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Unit" HeaderText="发表刊物名称" />
                    <asp:BoundField DataField="PublishTime" HeaderText="发表日期" DataFormatString="{0:yyyy-MM-dd}" />
                   ...
                   <asp:TemplateField HeaderText="级别">
                    ...
                    <asp:HyperLinkField HeaderText="查看" DataNavigateUrlFields="PK_LZID" 
                        DataNavigateUrlFormatString="/Preview/Thesis_Preview.aspx?cmd=preview&srid={0}" Text="查看" />
                    <asp:HyperLinkField DataNavigateUrlFields="PK_LZID" 
                        DataNavigateUrlFormatString="Thesis_Add.aspx?cmd=modify&srid={0}" 
