<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WanShanXinXi.aspx.cs" Inherits="Web.YongHuGuanLi.WanShanXinXi" %>
        ...
        <div>
            <center>
                   <table class="table-box" style=" width:50%;">
                        <tr>
                            <td class="Table_searchtitle" colspan="4"><div align="center" class="style1">完善个人信息</div></td>
                        </tr>
                        <tr>
                            <td class="table_body table_body_NoWidth">用户编号：</td>
                            <td class="table_none table_none_NoWidth">&nbsp;<asp:TextBox ID="TB_UserID" runat="server" 
                                    Enabled="False"></asp:TextBox>
                        </tr>
                        <tr>
                            
                            <td class="table_body table_body_NoWidth">用户名：</td>
                            <td class="table_none table_none_NoWidth">&nbsp;<asp:TextBox ID="TB_UserName" runat="server" ></asp:TextBox>
                                <asp:Label ID="Label1" runat="server" ForeColor="Red" Text="*"></asp:Label>
                                <asp:RequiredFieldValidator ID="RequiredName" ControlToValidate="TB_UserName" runat="server" ErrorMessage="不能空">
                                </asp:RequiredFieldValidator>    
                            </td>
                        </tr>
                        <tr>
                            <td class="table_body table_body_NoWidth">性别：</td>
                            <td class="table_none table_none_NoWidth">&nbsp;<asp:DropDownList ID="DropDL_Sex" runat="server" Width="154px">
                        ...
                        <tr>
                            ...
                            <td class="table_none table_none_NoWidth">&nbsp;<asp:DropDownList ID="DropDL_Degree" runat="server" Width="154px">
                        ...
                        <tr>
                            ...
                            <td class="table_none table_none_NoWidth">
                                &nbsp;<asp:DropDownList ID="TB_ZhiCheng" runat="server" Width="154px">
                        ...
                        <tr>
                            ...
                            <td class="table_none table_none_NoWidth">&nbsp;<asp:TextBox ID="TB_Email" runat="server" 
                                ...
                                <asp:RegularExpressionValidator ID="EmailRegular" runat="server"  
                                  ControlToValidate="TB_Email" ErrorMessage="格式错误"
                                    ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*">
                                    </asp:RegularExpressionValidator>
                            </td>
                        </tr>
                        <tr>
                            <td class="table_body table_body_NoWidth"> <div align="left"></div></td>
                            <td class="table_none table_none_NoWidth">&nbsp;(有红色标记的是必填项)</td>
                        </tr>
                        <tr>
