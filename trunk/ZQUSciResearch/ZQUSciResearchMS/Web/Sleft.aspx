<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sleft.aspx.cs" Inherits="Web.Sleft" %>
    ...
    <div style="height: 100%;">
        <ul id="navigation">
            ...
            <li class="main"><a class="head">科研信息审核</a>
                <ul>
                    <li><a href="Audit/FirstAudit.aspx" target="rightFrame">未审核科研信息</a></li>
                    <li><a href="Audit/FirstAudited.aspx" target="rightFrame">已审核科研信息</a></li>
                </ul>
            </li>
            <li class="main"><a class="head">查询统计</a>
                <ul>
                    <li><a href="Search/SearchByMishu.aspx" target="rightFrame">科研信息查询</a></li>
                    <li><a href="Print/PrintConditionByMishu.aspx" target="rightFrame">科研信息打印</a></li>
                    <li><a href="Print/CrystalReportByUnit.aspx" target="_blank">科研信息图表统计</a></li>
                </ul>
            </li>
