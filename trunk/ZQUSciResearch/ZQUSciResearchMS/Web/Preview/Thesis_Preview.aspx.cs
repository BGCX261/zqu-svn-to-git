...
{
    public partial class Thesis_Preview : System.Web.UI.Page
    {
        ...
        {
            //UpdateAuditState("1");
            //Response.Redirect("../SciResearch/Thesis_List.aspx");
            if (Session["Role"] != null)
            {
        ...
        {
            Response.Redirect("../SciResearch/Thesis_Add.aspx?cmd=modify&srid=" + lblSRID.Text + "");
        }
        #endregion
