...
{
    public partial class SKJD_Preview : System.Web.UI.Page
    {
        ...
        {
            //UpdateAuditState("1");
            //Response.Redirect("../SciResearch/SKJD_List.aspx");
            if (Session["Role"] != null)
            {
        ...
        {
            Response.Redirect("../SciResearch/SKJD_Add.aspx?cmd=modify&srid=" + lblSRID.Text + "");
        }
        #endregion
