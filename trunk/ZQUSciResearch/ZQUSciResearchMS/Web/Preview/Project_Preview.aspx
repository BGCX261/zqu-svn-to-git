<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Project_Preview.aspx.cs" Inherits="Web.Preview.Project_Preview" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>科研项目详细信息</title>
...
<body>
    ...
    <ajaxToolkit:TabPanel  HeaderText="科研项目详细信息" ID="TabPanel1" runat="server">
    <ContentTemplate>
        <div>
        <table class="table-box">
                    ...
                    <tr>
                        <td class="table_body table_body_NoWidth">项目编号：</td>
                        <td class="table_none table_none_NoWidth">
                    ...
                    <tr>
                        <td class="table_body table_body_NoWidth">项目立项日期：</td>
                        <td class="table_none table_none_NoWidth">
                            <asp:Label ID="lblTime" runat="server" Text="lblTime"></asp:Label></td>
                        <td class="table_body table_body_NoWidth">实到经费:</td>
                        <td class="table_none table_none_NoWidth">
                            <asp:Label ID="lblFund1" runat="server" Text="lblFund1"></asp:Label></td>
                    </tr>
                    <tr>
                        <td class="table_body table_body_NoWidth">项目类型:</td>
                        <td class="table_none table_none_NoWidth">
