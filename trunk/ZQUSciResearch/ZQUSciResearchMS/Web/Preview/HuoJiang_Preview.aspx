<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HuoJiang_Preview.aspx.cs" Inherits="Web.Preview.HuoJiang_Preview" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>获奖成果详细信息</title>
...
<body>
    ...
    <ajaxToolkit:TabPanel  HeaderText="获奖成果详细信息" ID="TabPanel1" runat="server">
    <ContentTemplate>
        <div>
        <table class="table-box">
                    ...
                    <tr>
                        <td class="table_body table_body_NoWidth">成果类别:</td>
                        <td class="table_none table_none_NoWidth">
                            <asp:Label ID="lblType" runat="server" Text="lblType"></asp:Label></td>
                        <td class="table_body table_body_NoWidth">获奖日期：</td>
                        <td class="table_none table_none_NoWidth">
                            <asp:Label ID="lblTime" runat="server" Text="lblTime"></asp:Label></td>
                    </tr>
                    <tr>
                        <td class="table_body table_body_NoWidth">奖项名称(级别)：</td>
                        <td class="table_none table_none_NoWidth">
                            <asp:Label ID="lblSource" runat="server" Text="lblSource"></asp:Label></td>
                        <td class="table_body table_body_NoWidth">获奖等级：</td>
                        <td class="table_none table_none_NoWidth">
