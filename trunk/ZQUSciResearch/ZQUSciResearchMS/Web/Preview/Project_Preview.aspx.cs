...
namespace Web.Preview
{
    public partial class Project_Preview : System.Web.UI.Page
    {
        ...
        private void BindData(string srid)
        {
            ...
            lblFund1.Text = ProjectModel.Funds1.ToString()+"万元";
        ...
        {
            //UpdateAuditState("1");
            //Response.Redirect("../SciResearch/Project_List.aspx");
            if (Session["Role"] != null)
            {
        ...
        {
            Response.Redirect("../SciResearch/Project_Add.aspx?cmd=modify&srid=" + lblSRID.Text + "");
        }
        #endregion
