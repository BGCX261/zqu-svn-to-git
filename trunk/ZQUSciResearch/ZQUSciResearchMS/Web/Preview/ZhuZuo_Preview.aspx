<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZhuZuo_Preview.aspx.cs" Inherits="Web.Preview.ZhuZuo_Preview" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>学术著作详细信息</title>
...
<body>
    ...
    <ajaxToolkit:TabPanel  HeaderText="学术著作详细信息" ID="TabPanel1" runat="server">
    <ContentTemplate>
        <div>
        <table class="table-box">
                    ...
                    <tr>
                        <td class="table_body table_body_NoWidth">著作编号：</td>
                        <td class="table_none table_none_NoWidth">
                    ...
                    <tr>
                        <td class="table_body table_body_NoWidth">著作类型:</td>
                        <td class="table_none table_none_NoWidth">
                            <asp:Label ID="lblType" runat="server" Text="lblType"></asp:Label></td>
                        <td class="table_body table_body_NoWidth">字数:</td>
                        <td class="table_none table_none_NoWidth">
                            <asp:Label ID="lblWord" runat="server" Text="lblWord"></asp:Label></td>
                    </tr>
                    <tr>
