<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZhuanLi_Preview.aspx.cs" Inherits="Web.Preview.ZhuanLi_Preview" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>专利成果详细信息</title>
...
<body>
    ...
    <ajaxToolkit:TabPanel  HeaderText="专利成果详细信息" ID="TabPanel1" runat="server">
    <ContentTemplate>
        <div>
        <table class="table-box">
                    ...
                    <tr>
                        <td class="table_body table_body_NoWidth">专利名称：</td>
                        <td colspan="3" class="table_none table_none_NoWidth">
                            <asp:Label ID="lblTitle" runat="server" Text="lblTitle"></asp:Label></td>
                    </tr>
                    <tr>
                        <td class="table_body table_body_NoWidth">授权日期：</td>
                        <td class="table_none table_none_NoWidth">
                            <asp:Label ID="lblTime" runat="server" Text="lblTime"></asp:Label></td>
                        <td class="table_body table_body_NoWidth">授权单位：</td>
                        <td class="table_none table_none_NoWidth">
                            <asp:Label ID="lblUnit" runat="server" Text="lblUnit"></asp:Label></td>
                    </tr>
                    <tr>
                        <td class="table_body table_body_NoWidth">专利类型:</td>
                        <td class="table_none table_none_NoWidth">
                            <asp:Label ID="lblType" runat="server" Text="lblType"></asp:Label></td>
                        <td class="table_body table_body_NoWidth">专利号:</td>
                        <td class="table_none table_none_NoWidth">
                            <asp:Label ID="lblNumber" runat="server" Text="lblNumber"></asp:Label></td>
                    </tr>
                    <tr>
