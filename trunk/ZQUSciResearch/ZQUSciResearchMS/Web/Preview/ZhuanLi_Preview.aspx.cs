...
{
    public partial class ZhuanLi_Preview : System.Web.UI.Page
    {
        ...
        {
            //UpdateAuditState("1");
            //Response.Redirect("../SciResearch/ZhuanLi_List.aspx");
            if (Session["Role"] != null)
            {
        ...
        {
            Response.Redirect("../SciResearch/ZhuanLi_Add.aspx?cmd=modify&srid=" + lblSRID.Text + "");
        }
        #endregion
