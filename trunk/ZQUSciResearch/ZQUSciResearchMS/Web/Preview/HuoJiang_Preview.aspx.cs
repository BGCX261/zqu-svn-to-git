...
{
    public partial class HuoJiang_Preview : System.Web.UI.Page
    {
        ...
        {
            //UpdateAuditState("1");
            //Response.Redirect("../SciResearch/HuoJiang_List.aspx");
            if (Session["Role"] != null)
            {
        ...
        {
            Response.Redirect("../SciResearch/HuoJiang_Add.aspx?cmd=modify&srid=" + lblSRID.Text + "");
        }
        #endregion
