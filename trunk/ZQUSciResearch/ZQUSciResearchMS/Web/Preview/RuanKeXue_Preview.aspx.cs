...
{
    public partial class RuanKeXue_Preview : System.Web.UI.Page
    {
        ...
        {
            //UpdateAuditState("1");
            //Response.Redirect("../SciResearch/RuanKeXue_List.aspx");
            if (Session["Role"] != null)
            {
        ...
        {
            Response.Redirect("../SciResearch/RuanKeXue_Add.aspx?cmd=modify&srid=" + lblSRID.Text + "");
        }
        #endregion
