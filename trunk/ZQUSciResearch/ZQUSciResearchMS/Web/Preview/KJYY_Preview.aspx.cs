...
{
    public partial class KJYY_Preview : System.Web.UI.Page
    {
        ...
        {
            //UpdateAuditState("1");
            //Response.Redirect("../SciResearch/KJYY_List.aspx");
            if (Session["Role"] != null)
            {
        ...
        {
            Response.Redirect("../SciResearch/KJYY_Add.aspx?cmd=modify&srid=" + lblSRID.Text + "");
        }
        #endregion
