<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KJYY_Preview.aspx.cs" Inherits="Web.Preview.KJYY_Preview" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>科技应用成果详细信息</title>
...
<body>
    ...
    <ajaxToolkit:TabPanel  HeaderText="科技应用成果详细信息" ID="TabPanel1" runat="server">
    <ContentTemplate>
        <div>
        <table class="table-box">
                    ...
                    <tr>
                        <td class="table_body table_body_NoWidth">获批日期：</td>
                        <td colspan="3" class="table_none table_none_NoWidth">
