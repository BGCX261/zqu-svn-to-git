...
{
    public partial class KJJD_Preview : System.Web.UI.Page
    {
        ...
        {
            //UpdateAuditState("1");
            //Response.Redirect("../SciResearch/KJJD_List.aspx");
            if (Session["Role"] != null)
            {
        ...
        {
            Response.Redirect("../SciResearch/KJJD_Add.aspx?cmd=modify&srid=" + lblSRID.Text + "");
        }
        #endregion
