<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShenBao_Preview.aspx.cs" Inherits="Web.Preview.ShenBao_Preview" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>项目申报详细信息</title>
...
<body>
    ...
    <ajaxToolkit:TabPanel  HeaderText="项目申报详细信息信息" ID="TabPanel1" runat="server">
    <ContentTemplate>
        <div>
        <table class="table-box">
                    ...
                    <tr>
                        <td class="table_body table_body_NoWidth">申报项目编号：</td>
                        <td class="table_none table_none_NoWidth">
                    ...
                    <tr>
                        <td class="table_body table_body_NoWidth">项目名称：</td>
                        <td colspan="3" class="table_none table_none_NoWidth">
                            <asp:Label ID="lblTitle" runat="server" Text="lblTitle"></asp:Label></td>
                    </tr>
                    <tr>
                        <td class="table_body table_body_NoWidth">项目申报日期：</td>
                        <td class="table_none table_none_NoWidth">
                            <asp:Label ID="lblTime" runat="server" Text="lblTime"></asp:Label></td>
                        <td class="table_body table_body_NoWidth">申报情况：</td>
                        <td class="table_none table_none_NoWidth">
                            <asp:Label ID="lblReviewState" runat="server" Text="lblReviewState"></asp:Label></td>
                    </tr>
                    <tr>
                        <td class="table_body table_body_NoWidth">申报项目类型:</td>
                        <td class="table_none table_none_NoWidth">
                            <asp:Label ID="lblType" runat="server" Text="lblType"></asp:Label></td>
                        <td class="table_body table_body_NoWidth">项目来源:</td>
                        <td class="table_none table_none_NoWidth">
                    ...
                    <tr>
                        ...
                        <td class="table_body table_body_NoWidth">是否项目主持人：</td>
                        <td class="table_none table_none_NoWidth">
                            <asp:Label ID="lblAnchorperson" runat="server" Text="lblAnchorperson"></asp:Label></td>
                    </tr>
                    <tr>
                        <td class="table_body table_body_NoWidth">
                            完成人数：</td>
