...
{
    public partial class ZhuZuo_Preview : System.Web.UI.Page
    {
        ...
        private void UpdateAuditState(string state)
        {
            ...
            LZJBll.UpdateAuditState(srid, state);
        }

        private void UpdateAuditState(string state, string reason)
        {
            string srid = lblSRID.Text;
            LZJBll.UpdateAuditState(srid, state, reason);
        }
        ...
        {
            //UpdateAuditState("1");
            //Response.Redirect("../SciResearch/ZhuZuo_List.aspx");
            if (Session["Role"] != null)
            {
        ...
        {
            Response.Redirect("../SciResearch/ZhuZuo_Add.aspx?cmd=modify&srid=" + lblSRID.Text + "");
        }
        #endregion
