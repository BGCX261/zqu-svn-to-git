<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KJJD_Preview.aspx.cs" Inherits="Web.Preview.KJJD_Preview" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>科技鉴定成果详细信息</title>
...
<body>
    ...
    <ajaxToolkit:TabPanel  HeaderText="科技鉴定成果详细信息" ID="TabPanel1" runat="server">
    <ContentTemplate>
        <div>
        <table class="table-box">
                    ...
                    <tr>
                        <td class="table_body table_body_NoWidth">鉴定部门:</td>
                        <td class="table_none table_none_NoWidth">
                            <asp:Label ID="lblUnit" runat="server" Text="lblUnit"></asp:Label></td>
                        <td class="table_body table_body_NoWidth">鉴定类型:</td>
                        <td class="table_none table_none_NoWidth">
