<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChuangZuo_Preview.aspx.cs" Inherits="Web.Preview.ChuangZuo_Preview" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>创作类成果详细信息</title>
...
<body>
    ...
    <ajaxToolkit:TabPanel  HeaderText="创作类成果详细信息" ID="TabPanel1" runat="server">
        <HeaderTemplate>
            创作类成果详细信息
        </HeaderTemplate>
    <ContentTemplate>
        ...
        <table class="table-box">
                    ...
                    <tr>
                        ...
                        <td class="table_body table_body_NoWidth">
                            所在学院:</td>
                        <td class="table_none table_none_NoWidth">
                            <asp:Label ID="lblUserUnit" runat="server" Text="lblUserUnit"></asp:Label>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="table_body table_body_NoWidth">所在类别：</td>
                        <td class="table_none table_none_NoWidth">
                    ...
                    <tr>
                        <td class="table_body table_body_NoWidth">学科:</td>
                        <td class="table_none table_none_NoWidth">
                            <asp:Label ID="lblType" runat="server" Text="lblType"></asp:Label></td>
                        <td class="table_body table_body_NoWidth">发表刊物名称/来源:</td>
                        <td class="table_none table_none_NoWidth">
