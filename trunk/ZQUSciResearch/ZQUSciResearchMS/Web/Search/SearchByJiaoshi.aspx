<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchByJiaoshi.aspx.cs" Inherits="Web.Search.SearchByJiaoshi" %>
...
<body>
    ...
    <ajaxToolkit:TabContainer ID="TabContainer1" runat="server">
        <ajaxToolkit:TabPanel HeaderText="科研信息查询" ID="TabPanel1" runat="server">
            <ContentTemplate>
            <div>
                    <asp:DropDownList ID="ddl_Condition" runat="server" AutoPostBack="True" 
                        onselectedindexchanged="ddl_Condition_SelectedIndexChanged">
                ...
                &nbsp;<asp:Label ID="lb_Start" runat="server" Text="从：" Visible="False"></asp:Label>
                    <asp:TextBox ID="Tbox_Start" runat="server" Visible="False" ValidationGroup="Group1"></asp:TextBox>
                    <ajaxToolkit:CalendarExtender ID="Tbox_Start_CalendarExtender" runat="server" 
                        Enabled="True" Format="yyyy-MM-dd" TargetControlID="Tbox_Start">
                ...
                <asp:TextBox ID="Tbox_End" runat="server" Visible="False" ValidationGroup="Group1"></asp:TextBox>
                    <ajaxToolkit:CalendarExtender ID="Tbox_End_CalendarExtender" runat="server" 
                        Enabled="True" Format="yyyy-MM-dd" TargetControlID="Tbox_End">
                    </ajaxToolkit:CalendarExtender>
