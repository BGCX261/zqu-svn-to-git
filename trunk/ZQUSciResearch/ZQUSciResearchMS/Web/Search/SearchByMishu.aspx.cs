...
{
    public partial class SearchByMishu : System.Web.UI.Page
    {
        ...
        private void BindDataBySort(string strsort)  //按类别返回数据
        {
            if (Session["UserID"] != null)
            {
                ...
                if (Unit != "")
                {
                    ...
                    ds1 = Bll.GetListByMishuBySort(Unit, strsort);
        ...
        private void BindDataByDate(string strStart, string strEnd)//按日期返回数据
        {
            if (Session["UserID"] != null)
            {
                ...
                if (Unit != "")
                {
                    ...
                    ds2 = Bll.GetListByMishuByDate(Unit, strStart, strEnd);
        ...
        private void BindDataByName(string strname) //按姓名返回数据
        {
            if (Session["UserID"] != null)
            {
                ...
                if (Unit != "")
                {
                    ...
                    ds3 = Bll.GetListByMishuByName(Unit,strname);
        ...
        protected void btn_Search_Click(object sender, EventArgs e) //按条件查询
        {
            ...
            else if(ddl_Condition.SelectedIndex==1) //按日期查询
            {
            ...
            else if (ddl_Condition.SelectedIndex==2)//按姓名查询
            {
                if (Tbox_Name.Text!="")
                {
