<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchByKeyuan.aspx.cs" Inherits="Web.Search.SearchByKeyuan" %>
...
<asp:ListItem Value="1">按单位查询</asp:ListItem>
                        <asp:ListItem Value="2">按日期查询</asp:ListItem>
                        <asp:ListItem Value="3">按姓名查询</asp:ListItem>
                </asp:DropDownList>
...
<asp:ListItem>科研项目</asp:ListItem>
                ...
                <asp:DropDownList ID="ddl_Unit" runat="server" Visible="False">
                <asp:ListItem Value="经济与管理学院">经济与管理学院</asp:ListItem>
                                    <asp:ListItem Value="政法学院">政法学院</asp:ListItem>
                                    <asp:ListItem Value="教育学院">教育学院</asp:ListItem>
                                    <asp:ListItem Value="体育与健康学院">体育与健康学院</asp:ListItem>
                                    <asp:ListItem Value="文学院">文学院</asp:ListItem>
                                    <asp:ListItem Value="外国语学院">外国语学院</asp:ListItem>
                                    <asp:ListItem Value="美术学院">美术学院</asp:ListItem>
                                    <asp:ListItem Value="数学与信息科学学院">数学与信息科学学院</asp:ListItem>
                                    <asp:ListItem Value="化学化工学院">化学化工学院</asp:ListItem>
                                    <asp:ListItem Value="生命科学学院">生命科学学院</asp:ListItem>
                                    <asp:ListItem Value="电子信息与机电工程学院">电子信息与机电工程学院</asp:ListItem>
                                    <asp:ListItem Value="计算机学院">计算机学院</asp:ListItem>
                                    <asp:ListItem Value="软件学院">软件学院</asp:ListItem>
                                    <asp:ListItem Value="旅游学院">旅游学院</asp:ListItem>
                                    <asp:ListItem Value="思想政治理论教学部">思想政治理论教学部</asp:ListItem>
                                    <asp:ListItem Value="继续教育学院">继续教育学院</asp:ListItem>
                                    <asp:ListItem Value="国际交流学院">国际交流学院</asp:ListItem>
                                    <asp:ListItem Value="应用技术师范学院">应用技术师范学院</asp:ListItem>
                                    <asp:ListItem Value="音乐学院">音乐学院</asp:ListItem>
                                    <asp:ListItem Value="科研秘书处">科研秘书处</asp:ListItem>
                                    <asp:ListItem Value="科员处">科员处</asp:ListItem>
                                    <asp:ListItem Value="处长室">处长室</asp:ListItem>
