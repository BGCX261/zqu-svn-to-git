<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Uncommitted.aspx.cs" Inherits="Web.Audit.Uncommitted" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>科研成果/业绩未提交列表</title>
...
<body>
    ...
    <ajaxToolkit:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0">
        <ajaxToolkit:TabPanel HeaderText="科研成果/业绩未提交列表" ID="TabPanel1" runat="server">
        <ContentTemplate>
            <div>
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="gridviewStyle"  
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="操作">
                        <ItemTemplate>
                            <asp:LinkButton ID="lbtnAudit" runat="server" CommandName="Audit" CommandArgument='<%#Eval("PK_AID") %>'>提交</asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
                <EmptyDataTemplate>
