...
namespace Web.Audit
{
    public partial class FirstAudited : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            //if (!IsPostBack)
            //{
            //    PeriodsModel = PeriodsBll.GetModel(2);
            ...
            //    {
            //        Response.Redirect("/Message/TimeSetMessage.aspx?tid=2");
            //    }
            //    else
            //    {
                    BindData();
        ...
        private void BindData()
        {
            if (Session["UserID"] != null)
            {
                ...
                if (unit != "")
                {
                    ...
                    ds = Bll.GetListByMishuAudited(unit,userID);
