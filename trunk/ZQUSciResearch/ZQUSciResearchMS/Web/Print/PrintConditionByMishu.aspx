<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrintConditionByMishu.aspx.cs" Inherits="Web.Print.PrintConditionByMishu" %>
...
<body>
    ...
    <ajaxToolkit:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0">
        ...
        <ContentTemplate>
            <div>
                <asp:Label ID="Label1" runat="server" Text="请输入所要打印的日期范围："></asp:Label>

                    &nbsp; &nbsp;<asp:Label ID="lb_Start" runat="server" Text="从" ></asp:Label>

                    <asp:TextBox ID="Tbox_Start" runat="server"></asp:TextBox>
                ...
                <asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage="开始日期不能晚于结束日期" Display="Dynamic" ControlToCompare="Tbox_Start" ControlToValidate="Tbox_End" Operator="GreaterThanEqual" ValidationGroup="Group1"></asp:CompareValidator>
                    &nbsp;&nbsp;<asp:Button ID="btn_Search" CssClass="ButtonCss" runat="server" Text="按日期查询" 
             ...
             <div>
                <div style="text-align:right; margin-right:33px">
                <asp:Label ID="Label2" runat="server" Text="注：可供打印的科研信息只能是二审通过以后的信息。" ForeColor="Red"></asp:Label>
                <asp:LinkButton ID="btn_Print" runat="server" Font-Bold="True" Text="打印" href="../Print/PrintByMishu.aspx" target="_blank" 
