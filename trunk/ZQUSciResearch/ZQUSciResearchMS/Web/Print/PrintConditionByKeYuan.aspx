<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrintConditionByKeYuan.aspx.cs" Inherits="Web.Print.PrintConditionByKeYuan" %>
        ...
        <ContentTemplate>
            <div>
             ...
             <div>
                ...
                <asp:LinkButton ID="btn_Print" runat="server" Font-Bold="True" Text="打印" href="../Print/PrintByKeyuan.aspx" target="_blank" 
